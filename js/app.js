  ...
  var e = {
      ...
      630: function (e, t) {
        ...
        (s = [e, t]),
                ...
                return (
                  o(e, [
                    ...
                    },
                    {
                      ...
                      value: function (e, t) {
                        for (
                          var i = f(e), s = i.getPropertyCSSValue(t), n = 0;
                      ...
                      value: function (e) {
                        var t =
                          ...
                          i =
                            ...
                            window.pageYOffset,
                          s = i + Math.min(this.element.clientHeight, p()) - t,
                          n = this.offsetTop(e),
                          o = n + e.clientHeight;
                        return n <= s && o >= i;
                      },
          ...
          void 0 === (n = "function" == typeof i ? i.apply(t, s) : i) ||
            (e.exports = n);
      },
    },
    t = {};
  ...
  (() => {
    ...
    const X = {
      ...
      updateSlides: function () {
        ...
        if (
          ...
          T && e.grid.updateWrapperSize(x, h, t),
          !s.centeredSlides)
        ) {
          const t = [];
      ...
      slideTo: function (e, t, i, s, n) {
        ...
        if (a.cssMode) {
          ...
          if (0 === t) {
            ...
            if (!o.support.smoothScroll)
              return (
                z({ swiper: o, targetPosition: i, side: e ? "left" : "top" }),
                !0
              );
    ...
    function fe(e) {
      ...
      const n = (e, i) => {
        ...
        o = () => {
          const { $el: e, slides: i, progress: s, snapGrid: o } = t;
          e
            .children(
      ...
      ve(),
        ...
        document.querySelector(".tips__slider") &&
          new ue(".tips__slider", {
            ...
            navigation: {
              nextEl: ".tips__container .slider-arrow_next",
              prevEl: ".tips__container .slider-arrow_prev",
            },
            breakpoints: {
        ...
        return (
          ...
          (e.prototype.loadContent = function (e, t) {
            ...
            if (
              ...
              if (m) {
                ...
                S = Ue(o, T || "", g, this.settings.strings.playVideo, p);
                n.prepend(S);
              } else if (p) {
          ...
          (e.prototype.enableDrag = function () {
            ...
            this.settings.enableDrag &&
              ...
              We(window).on("mousemove.lg.global" + this.lgId, function (o) {
                s &&
                  e.lgOpened &&
                  ((n = !0),
              ...
              We(window).on("mouseup.lg.global" + this.lgId, function (o) {
                if (e.lgOpened) {
                  var r = We(o.target);
                  n
                    ? ((n = !1), e.touchEnd(i, t, o), e.LGel.trigger(ze))
                    : e.isPosterElement(r) && e.LGel.trigger(ke),
                    s &&
                      ((s = !1),
          ...
          (e.prototype.closeGallery = function (e) {
            ...
            this.LGel.trigger(Be), We(window).scrollTop(this.prevScrollTop);
            var i,
    ...
    (rt.prototype.init = function () {
      ...
      (rt.prototype.moveTo = function (e, t, i) {
      ...
      (rt.prototype.moveBack = function (e, t, i) {
    ...
    new rt("max").init(),
      (window.onload = function () {
        document.addEventListener("click", function (e) {
          ...
          i.classList.contains("serch-form__icon")
            ? document.querySelector(".serch-form").classList.toggle("_active")
            : !i.closest(".serch-form") &&
              document.querySelector(".serch-form._active") &&
              document
          ...
          i.classList.contains("products__more") &&
                  ...
                  !(function (e) {
                    ...
                    e.products.forEach((e) => {
                      const i = e.id,
                        ...
                        c = e.likeUrl,
                        u = e.labels;
                      let h = `<article data-pid="${i}" class="products__item item-product">`,
                        p = "</article>",
                        g = "";
                      if (u) {
                        let e = '<div class="item-product__labels">',
                          ...
                          i = "";
                        u.forEach((e) => {
                          i += `<div class="item-product__label item-product__label_${e.type}">${e.value}</div>`;
                        }),
                          (g += e),
                          (g += i),
                          (g += t);
                      ...
                      (m = '<div class="item-product__prices">'),
                        (m += `<div class="item-product__price"> ${a}</div>`),
                        l &&
                          (m += `<div class="item-product__price item-product__price_old"> ${l}</div>`),
                        (m += "</div>");
                      let f = "";
                      (f += '<div class="item-product__body">'),
                        (f += `\n\t\t<div class="item-product__content">\n\t\t\t<h3 class="item-product__title">${o}</h3>\n\t\t\t<div class="item-product__text">${r}</div>\n\t\t</div>\n\t`),
                        (f += m),
                        (f += `\n\t\t<div class="item-product__actions action-product">\n\t\t\t<div class="action-product__body">\n\t\t\t\t<a href="" class="action-product__button button button_white">Add to cart</a>\n\t\t\t\t<a href="${d}" class="action-product__link _icon-share">Share</a>\n\t\t\t\t<a href="${c}" class="action-product__link _icon-favorite">Like</a>\n\t\t\t</div>\n\t\t</div>\n\t`),
                        (f += "</div>");
                      let v = "";
                      (v += h),
                        (v += g),
                        (v += `\n\t\t<a href="${s}" class="item-product-ibg item-product__image">\n\t\t\t<img src="img/products01/fashionProducts/${n}" alt="${o}">\n\t\t</a>\n\t`),
                        (v += f),
                        (v += p),
            ...
            e.preventDefault());
          if (i.classList.contains("action-product__button")) {
            const s = i.closest(".item-product").dataset.pid;
            !(function (e, i) {
              if (!e.classList.contains("_hold")) {
                ...
                o.setAttribute("class", "_flyImage-ibg"),
                  (o.style.cssText = `\n\t\t\tleft: ${d}px;\n\t\t\ttop: ${l}px;\n\t\t\twidth: ${r}px;\n\t\t\theight: ${a}px;\n\t\t`),
                ...
                (o.style.cssText = `\n\t\t\tleft: ${c}px;\n\t\t\ttop: ${u}px;\n\t\t\twidth: 0px;\n\t\t\theight: 0px;\n\t\t\topacity:0;\n\t\t`),
                  o.addEventListener("transitionend", function () {
                    e.classList.contains("_fly") &&
                      (o.remove(), t(e, i), e.classList.remove("_fly"));
                  });
              }
            })(i, s),
              e.preventDefault();
          ...
          i.closest(".cart-header__icon")
            ...
            : i.closest(".cart-header") ||
              i.classList.contains("action-product__button") ||
              document
                .querySelector(".cart-header")
                .classList.remove("_active");
          if (i.classList.contains("cart-list__delete")) {
            const s = i.closest(".cart-list__item").dataset.cartPid;
            t(i, s, !1), e.preventDefault();
          }
        });
        ...
        function t(e, t, i = !0) {
          ...
          if (i) {
            ...
            const t = --o.innerHTML;
            t ? (o.innerHTML = t) : (o.remove(), s.classList.remove("_active"));
          }
        }
        ...
        if (i) {
          const s = document.querySelector(".furniture__items"),
            n = document.querySelectorAll(".furniture__column"),
            o = i.dataset.speed;
          let r = 0,
            a = 0;
          function l() {
            ...
            r += d * o;
            let c = (t / 200) * r;
            (s.style.cssText = `transform: translate3d(${-c}px,0,0);`),
              Math.abs(d) > 0
          ...
          i.addEventListener("mousemove", function (e) {
            ...
            (a = (s / t) * 200),
              i.classList.contains("_init") ||
                (requestAnimationFrame(l), i.classList.add("_init"));
          });
        }
      }),
      new (i(630))().init(),
